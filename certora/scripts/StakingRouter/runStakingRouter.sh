...
\
--link \
StakingRouterHarness:DEPOSIT_CONTRACT=DepositContract \
...
StakingModuleMock=solc8.9,DepositContract=solc6.11,\
...
--settings -t=3200,-depth=15,-mediumTimeout=100,-copyLoopUnroll=6,-optimisticUnboundedHashing=true \
--msg "Staking Router"