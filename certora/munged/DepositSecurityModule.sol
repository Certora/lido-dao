...
contract DepositSecurityModule {
    ...
    address[] public guardians;           // HARNESS: internal -> public
    mapping(address => uint256) public guardianIndicesOneBased; // 1-based    // HARNESS: internal -> public
    ...
    function depositBufferedEther(
        ...
        Signature[] memory sortedGuardianSignatures         // HARNESS: calldata -> memory
    ) public validStakingModuleId(stakingModuleId) {        // HARNESS: external -> public
