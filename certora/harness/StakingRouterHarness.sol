...
import {AccessControlEnumerable} from "../../node_modules/@openzeppelin/contracts-v4.4/access/AccessControlEnumerable.sol";

import {ILido} from "../../contracts/0.8.9/interfaces/ILido.sol";
import {IStakingRouter} from "../../contracts/0.8.9/interfaces/IStakingRouter.sol";
import {IStakingModule} from "../../contracts/0.8.9/interfaces/IStakingModule.sol";
import {IDepositContract} from "../../contracts/0.8.9/interfaces/IDepositContract.sol";

import {Math} from "../../contracts/0.8.9/lib/Math.sol";
import {BatchedSigningKeys} from "../../contracts/0.8.9/lib/BatchedSigningKeys.sol";
import {UnstructuredStorage} from "../../contracts/0.8.9/lib/UnstructuredStorage.sol";
import {MinFirstAllocationStrategy} from "../../contracts/0.8.9/lib/MinFirstAllocationStrategy.sol";
...
contract StakingRouter is IStakingRouter, AccessControlEnumerable, BeaconChainDepositor {
    ...
    function getModuleActiveKeysCount(
        uint24 _stakingModuleId
     ...
     */
    function _loadAllStakingModulesCache(
        bool _isRewardDistribution
    ) internal view returns (uint totalActiveKeys, StakingModuleCache[] memory modulesCache) {
        uint256 _modulesCount = getStakingModulesCount();
    ...
    function _getKeysAllocation(
        ...
        bool _isRewardDistribution
    ) internal view returns (uint256 allocated, uint256[] memory allocations, StakingModuleCache[] memory _modulesCache) {
